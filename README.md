...
Not all of you made it to last class -- we had some great discussions of possible research topics! 
We've seen people interested in:

- Interest rates, Inflation and Unconventional monetary policy
- Foreign exchange markets
- Systematic vs Discretionary portfolio management after 2021 
- The economic/financial effects of pandemics
- Monetary policy and asset valuations 
- Machine learning applied to volatility forecasting 
- The economic effects of migration policies

This is quite interesting and diverse! I am happy with where this is going. 

Moving on to announcements.

If you have already formed a group, please let me know via email. Please include all members of the group in the email (name and ID). Remember, the minimum is 2 and the maximum is 4. If you don't yet have a group, that is fine.

Also, I have asked each person to read a paper covering the topic they brought up last class, and quickly talk about it next meeting (5-10 minutes). There is no need to bring slides. I suggest writing down a few bullet points (for yourself) to guide your discussion of the paper. *This is still an individual assignment, even if you already have a group!*

Please email me by Sunday the paper you wish to discuss.

A few notes about this task:

- Some papers are very technical and require more than a week to understand fully: that is completely fine! Don't lose sleep over not understanding every sentence. I would focus on understanding the introduction and being able to communicate the main result of the paper. That should not take more than a couple of hours.

- Don't get dragged into the prior literature rabbit hole! Most papers should be self-contained but will have lots of references to prior work. Please resist the temptation of wanting a "bottom-up" understanding, trying to trace out the "history of economic thought" for that literature. That is a guaranteed way of distracting yourself from the main task. 

- If you really want a bigger picture understanding of that literature, instead of going down the citations rabbit hole, find a survey that cites the paper you're reading, read it quickly, and come back to the original paper. Google scholar is your friend!
...
- Reminder: next class, you need to present a 2-5 min description of something, or a set of things you find interesting.

  That could be:
 
  - A paper
  - A broad research question
  - A blog post, book, sell-side report
  - Something from a previous course you found interesting (problem set, etc)
 
  **The goal is to help form groups based on interest. Please do not make it too long!**

Also, this is not graded. 
...
Instead of having a PDF syllabus, I chose to host a website with the course information and announcements. 

Please stay tuned to 

https://pereiragc.github.io/NYU-SpecialProject

especially to the announcements section. Any announcements I make via email to the class will also be pasted there.

The literature/topic suggestions will also get further updates, but I think it is in a decent shape.

By the way: if someone volunteers to create a Zotero folder with the suggested readings, and share them with all students, that would be awesome! (If you don't know Zotero, I strongly suggest you look up and adopt.)
